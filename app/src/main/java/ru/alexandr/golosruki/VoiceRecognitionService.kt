...
class VoiceRecognitionService : Service(), RecognitionListener {
    ...
    override fun onResult(hypothesis: String?) {
        ...
        // Экран звонка обрабатывается как обычный экран (как в ранних версиях):
        // никакого особого перехвата — команды идут штатным путём, сетка/номера/жесты
        // и сброс работают как везде. Спец-обработка звонка убрана намеренно.
